...
Cube::Cube(const glm::vec3 &pos, float mass)
{
    if (!m_Initialized)
    {
        float vertices[] = {
...
void Cube::Draw(Shader &shader, glm::vec3 position, glm::vec3 scale)
{
    ...
    void Cube::SetPosition() const {

    }
    void Cube::SetAcceleration() const {

    }
    void Cube::SetMass() const {
